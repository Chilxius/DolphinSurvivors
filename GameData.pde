...
class GameData
{
  ...
  void loadImages()
  {
    ...
    images.put("pickup-money",     loadImage("copperPiece.png") ); images.get("pickup").resize(50,0);
    images.put("pickup-health",     loadImage("copperPiece.png") ); images.get("pickup").resize(50,0);
