...
class GameData
{
  ...
  void loadImages()
  {
    ...
    images.put("boss",          loadImage("boss.png") );          images.get("boss").resize(50,0);
    images.put("bossFlip",      loadImage("bossFlip.png") );      images.get("bossFlip").resize(50,0);
    ...
    images.put("net",            loadImage("deepDarkNet.png") );    images.get("net").resize(50, 0); // (39 x 52)
    ...
    images.put("hook",           loadImage("hook.png") );           images.get("hook").resize(0,75);
  }
